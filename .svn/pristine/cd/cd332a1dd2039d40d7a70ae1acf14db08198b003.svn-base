...
public class DHKeyExchangeCrypto {
	...
	public static String strToPerformActionOn = "SomeValue";

	// Driver function
	public static void test(String data) throws Exception {
		strToPerformActionOn = data;
		...
		System.out.println("receiverPublicKey: " + receiverPublicKey);
		...
		System.out.println("\n");
		System.out.println("Data to encrypt: " + strToPerformActionOn + " , encrypted Data: " + encryptedData
	...
	public static void encrpt(String data, String path) throws Exception {
		Security.addProvider(new BouncyCastleProvider());
	...
	public static String encrypt(byte[] xorOfRandom, String senderPrivateKey, String receiverPublicKey,
			String stringToEncrypt) throws Exception {
	...
	public static String decrypt(byte[] xorOfRandom, String receiverPrivateKey, String senderPublicKey,
			String stringToDecrypt) throws Exception {
	...
	protected static byte[] xorOfRandom(String randomKeySender, String randomKeyReceiver) {
	...
	/*
	 * If using ProjectEka HIU for the decryption then Please use below methods for
