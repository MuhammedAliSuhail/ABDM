...
public class ResourcePopulator {
	...
	public static Condition populateConditionResource() {
		...
		condition.getText().setStatus(NarrativeStatus.GENERATED)
				.setDivAsString("<div xmlns=\"http://www.w3.org/1999/xhtml\">Abdominal pain on 09-July 2020</div>");
	...
	public static Appointment populateAppointmentResource() {
		...
		appointment.getParticipant()
				.add(new AppointmentParticipantComponent().setActor(new Reference().setReference("Patient/Patient-01"))
						.setStatus(ParticipationStatus.ACCEPTED)
						.setActor(new Reference().setReference("Practitioner/Practitioner-01"))
						.setStatus(ParticipationStatus.ACCEPTED));
	...
	public static DiagnosticReport populateDiagnosticReportImagingDCMResource() {
		...
		diagnosticReportImaging.setCode(
				new CodeableConcept(new Coding("http://loinc.org", "82692-5", "CT Head and Neck WO contrast")));
		diagnosticReportImaging.getResultsInterpreter()
				.add(new Reference().setReference("Organization/Organization-01").setDisplay("Dr. DEF"));
		diagnosticReportImaging.getMedia()
				.add(new DiagnosticReportMediaComponent(new Reference().setReference("Media/Media-01")));
	...
	public static Encounter populateSecondEncounterResource() {
		...
		encounter
				.setHospitalization(new EncounterHospitalizationComponent().setDischargeDisposition(new CodeableConcept(
						new Coding("http://terminology.hl7.org/CodeSystem/discharge-disposition", "home", "Home"))
								.setText("Discharged to Home Care")));
		encounter.addDiagnosis().setCondition(new Reference().setReference("Condition/Condition-01"))
				.setUse(new CodeableConcept(new Coding("http://snomed.info/sct", "33962009", "Chief complaint")))
				.setCondition(new Reference().setReference("Condition/Condition-03"))
	...
	public static ImmunizationRecommendation populateImmunizationRecommendation() {
		...
		immunizationRecommendation.setId("1");
	...
	public static MedicationRequest populateMedicationRequestResource() {
		...
		medicationRequest.setMedication(new CodeableConcept(new Coding("http://snomed.info/sct", "324252006",
		...
		medicationRequest
				.setRequester(new Reference().setReference("Practitioner/Practitioner-01").setDisplay("Dr DEF"));
		medicationRequest.getReasonCode().add(new CodeableConcept(
				new Coding("http://snomed.info/sct", "11840006", "Traveller's Diarrhea (disorder)")));
	...
	public static Observation populateCholesterolObservationResource() {
		...
		observation.setStatus(ObservationStatus.FINAL);
		observation.setCode(new CodeableConcept(
				new Coding("http://loinc.org", "35217-9", "Triglyceride [Moles/​volume] in Serum or Plasma"))
						.setText("Triglycerides, serum by Enzymatic method"));
		observation.setValue(new Quantity().setValueElement(new DecimalType("6.3")).setCode("258813002")
				.setUnit("mmol/L").setSystem("http://snomed.info/sct"));
		observation.getReferenceRange().add(
				new ObservationReferenceRangeComponent().setHigh(new Quantity().setValueElement(new DecimalType("4.5"))
						.setCode("258813002").setUnit("mmol/L").setSystem("http://snomed.info/sct")));
		observation.setSubject(new Reference().setReference("Patient/Patient-01"));
	...
	public static Observation populateTriglycerideObservationResource() {
		...
		observation.setCode(new CodeableConcept(
				new Coding("http://loinc.org", "35217-9", "Triglyceride [Moles/​volume] in Serum or Plasma"))
						.setText("Triglycerides, serum by Enzymatic method"));
		observation.setValue(new Quantity().setValueElement(new DecimalType("1.3")).setCode("258813002")
				.setUnit("mmol/L").setSystem("http://snomed.info/sct"));
		observation.getReferenceRange().add(
				new ObservationReferenceRangeComponent().setHigh(new Quantity().setValueElement(new DecimalType("2.0"))
						.setCode("258813002").setUnit("mmol/L").setSystem("http://snomed.info/sct")));
		observation.setSubject(new Reference().setReference("Patient/Patient-01"));
		observation.addPerformer().setReference("Organization/Organization-02");
		return observation;
	...
	public static PractitionerRole populatePractitionerRoleResource() {
		...
		practitionerRole
				.setPractitioner(new Reference().setReference("Practitioner/Practitioner-01").setDisplay("Dr DEF"));
	...
	public static Procedure populateProcedureResource() {
		...
		procedure.getComplication()
				.add(new CodeableConcept(new Coding("http://snomed.info/sct", "131148009", "Bleeding")));
		return procedure;
	}
	...
	public static Observation populateHeartRateResource() {
		...
		observation.setSubject(new Reference().setReference("Patient/1"));
		observation.setEffective(new DateTimeType("2020-09-29"));
		observation.setValue(new Quantity().setValue(26).setUnit("beats/minute").setSystem("http://unitsofmeasure.org")
				.setCode("/min"));
	...
	public static Observation populateCaloriesBurnedResource() {
		Observation observation = new Observation();
		observation.setId("CaloriesBurned");
		observation.getMeta()
				.addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationPhysicalActivity");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
		...
		observation.setSubject(new Reference().setReference("Patient/1"));
		observation.addPerformer(new Reference().setReference("Organization/1"));
		observation.setValue(
	...
	public static Observation populateSleepDurationResource() {
		Observation observation = new Observation();
		observation.setId("SleepDuration");
		observation.getMeta()
				.addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationPhysicalActivity");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
	...
	public static Observation populateBloodGlucoseResource() {
		Observation observation = new Observation();
		observation.setId("BloodGlucose");
		observation.getMeta()
				.addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationGeneralAssessment");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
	...
	public static Observation populateFluidIntakeResource() {
		Observation observation = new Observation();
		observation.setId("FluidIntake");
		observation.getMeta()
				.addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationGeneralAssessment");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
				"<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Narrative with Details</b></p><p><b>id</b>: FluidIntake</p><p><b>status</b>: final</p><p><b>code</b>: Fluid intake oral Estimated <span>(Details : LOINC code '8999-5' = 'Fluid intake oral Estimated', given as 'Fluid intake oral Estimated')</span></p><p><b>subject</b>: ABC</p><p><b>value</b>: 3 Litres</p></div>");
		observation.setStatus(ObservationStatus.FINAL);
	...
	public static Observation populateCalorieIntakeResource() {
		Observation observation = new Observation();
		observation.setId("CalorieIntake");
		observation.getMeta()
				.addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationGeneralAssessment");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
	...
	public static Observation populateAgeOfMenarcheResource() {
		Observation observation = new Observation();
		observation.setId("AgeOfMenarche");
		observation.getMeta().addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationWomenHealth");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
				"<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Narrative with Details</b></p><p><b>id</b>: AgeOfMenarche</p><p><b>status</b>: final</p><p><b>code</b>: Age at menarche <span>(Details : LOINC code '42798-9' = 'Age at menarche', given as 'Age at menarche')</span></p><p><b>subject</b>: ABC</p><p><b>value</b>: 14 age</p></div>");
		observation.setStatus(ObservationStatus.FINAL);
	...
	public static Observation populateLastMenstrualPeriodResource() {
		Observation observation = new Observation();
		observation.setId("LastMenstrualPeriod");
		observation.getMeta().addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationWomenHealth");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
	...
	public static Observation populateDietTypeResource() {
		Observation observation = new Observation();
		observation.setId("DietType");
		observation.getMeta().addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationLifestyle");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
				"<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Narrative with Details</b></p><p><b>id</b>: DietType</p><p><b>status</b>: final</p><p><b>code</b>: Diet [Type] <span>(Details : LOINC code '81663-7' = 'Diet [Type]', given as 'Diet [Type]')</span></p><p><b>subject</b>: ABC</p><p><b>value</b>: Vegan<span> (Details: SNOMED CT code 24930006 = 'Vegan', given as 'Vegan')</span></p></div>");
		observation.setStatus(ObservationStatus.FINAL);
		observation.setCode(
				new CodeableConcept(new Coding("http://loinc.org", "8665-2", "Diet [Type]")).setText("Diet [Type]"));
		observation.setSubject(new Reference().setReference("Patient/1"));
		observation.getValueCodeableConcept().addCoding(new Coding("http://snomed.info/sct", "24930006", "Vegan"))
				.setText("Vegan");
	...
	public static Observation populateTobaccoSmokingStatusResource() {
		Observation observation = new Observation();
		observation.setId("TobaccoSmokingStatus");
		observation.getMeta().addProfile("https://nrces.in/ndhm/fhir/r4/StructureDefinition/ObservationLifestyle");
		observation.getText().setStatus(NarrativeStatus.GENERATED);
		observation.getText().setDivAsString(
	...
	public static Observation populateBloodPressureResource() {
		...
		observation.addInterpretation(new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation","L","low")).setText("Below low normal"));
		...
		component.setValue(new Quantity().setValue(107).setUnit("mmHg").setSystem("http://unitsofmeasure.org").setCode("mm[Hg]"));
		component.addInterpretation(new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation","N","normal")).setText("Normal"));
		...
		component1.setValue(new Quantity().setValue(60).setUnit("mmHg").setSystem("http://unitsofmeasure.org").setCode("mm[Hg]"));
		component1.addInterpretation(new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation","L","low")).setText("Below low normal"));
